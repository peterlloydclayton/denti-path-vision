...
const ApplicationSchema = z.object({
  ...
  monthly_income: z.number().min(0).max(1000000).optional(),
  monthly_net_income: z.number().min(0).max(1000000).optional(),
  pay_frequency: z.string().max(50).optional(),
  secondary_income_sources: z.string().max(500).optional(),
  household_total_income: z.number().min(0).max(1000000).optional(),
  spouse_employer: z.string().max(200).optional(),
  spouse_income: z.number().min(0).max(1000000).optional(),
  years_at_job: z.number().min(0).max(100).optional(),
  checking_balance: z.number().min(0).max(1000000).optional(),
  savings_balance: z.number().min(0).max(1000000).optional(),
  cash_on_hand: z.number().min(0).max(999999999).optional(),
  investments: z.number().min(0).max(999999999).optional(),
  retirement_accounts: z.number().min(0).max(1000000).optional(),
  ...
  monthly_housing_cost: z.number().min(0).max(1000000).optional(),
