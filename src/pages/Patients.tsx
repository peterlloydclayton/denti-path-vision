  ...
  return (
    <div className="overflow-x-hidden">
      ...
      <section className="min-h-screen bg-dental-blue-muted relative z-30 overflow-visible">
          ...
          <div className="flex sm:hidden justify-start items-start pt-20 h-[calc(100vh-5rem)] ml-[25%]">
            ...
            <div className="w-full max-w-md h-[calc(100vh-5rem)] relative z-[100]">
              <img 
                src="https://res.cloudinary.com/drxvhwze4/image/upload/v1758032045/patient-woman-latina_t6hmm3.png"
                alt="Happy patient with dental financing"
                className="absolute bottom-16 left-[-150px] transform-none w-auto object-contain object-bottom z-[110] max-w-none hero-image h-[calc(90vh-12rem)]"
              />
            </div>
          </div>
        </div>
        ...
        <div className="block sm:hidden absolute bottom-[30%] left-6 z-[150]" style={{ transform: 'translateY(0.3em)' }}>
