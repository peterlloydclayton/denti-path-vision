    ...
    <div className="overflow-x-hidden">
      ...
      <section className="min-h-screen bg-dental-blue-muted relative z-30 sm:overflow-visible md:overflow-hidden">
        <div className="container mx-auto px-2 md:px-6 min-h-screen sm:overflow-visible md:overflow-hidden">
          ...
          <div className="hidden sm:flex md:hidden flex-col justify-start items-start min-h-screen pt-0 ml-[-25%] border-4 border-red-500 relative z-[200]">
            ...
            <div className="w-full max-w-md relative z-[210] flex-1 flex items-end border-4 border-blue-500">
              <img 
