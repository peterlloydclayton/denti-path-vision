          ...
          <div className="flex justify-start md:justify-center items-start pt-20 md:items-center md:pt-0 min-h-screen ml-[10%] sm:ml-[15%] md:ml-0">
            ...
            <div className="w-full max-w-md min-h-screen relative border-4 border-blue-500 z-[100]">
              <img 
                ...
                className="absolute bottom-0 left-0 sm:left-[15%] md:left-1/2 transform-none sm:-translate-x-1/2 w-auto object-contain object-bottom z-[110] max-w-none hero-image h-[calc((100vh-6rem)*0.92)] sm:h-[calc((100vh-6rem)*0.82)] md:h-[85vh] border-4 border-red-500"
              />
            </div>
          </div>
        </div>
