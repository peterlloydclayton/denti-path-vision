          ...
          <div className="flex justify-start md:justify-center items-start pt-20 md:items-center md:pt-0 min-h-screen">
            ...
            <div className="w-full max-w-md min-h-screen relative border-2 border-blue-500 sm:border-0">
              <img 
                ...
                className="absolute bottom-0 left-[60%] md:left-1/2 transform -translate-x-1/2 w-auto object-contain object-bottom z-10 max-w-none hero-image h-[calc((100vh-6rem)*0.92)] md:h-[85vh] border-2 border-red-500 sm:border-0"
              />
            </div>
          </div>
        </div>
