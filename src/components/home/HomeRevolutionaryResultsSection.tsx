  ...
  const beforeAfterComparisons = [
    {
      ...
      before: { value: '20-40%', label: 'Traditional Banking' },
      after: { value: '95%', label: 'DentiPay AI' }
    },
    {
      metric: 'Decision Time',
      before: { value: '2-4 Weeks', label: 'Manual Process' },
      after: { value: '30 Seconds', label: 'Pre-Cognitive AI' }
    },
    {
      metric: 'Data Points',
      before: { value: '3-5', label: 'Basic Credit Check' },
      after: { value: '50+', label: 'Comprehensive Analysis' }
    }
  ];
    ...
    <section className="py-24 bg-gradient-to-b from-surface to-background relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <ScrollReveal className="text-center mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-success/10 to-primary/10 border border-success/20 text-success font-medium text-sm mb-6">
              ...
              >
                <Card className={`border-${stat.color}/30 bg-gradient-to-br from-${stat.color}/5 to-${stat.color}/10 hover:shadow-2xl hover:shadow-${stat.color}/20 transition-all duration-500 h-full`}>
                  <CardContent className="p-8 text-center h-full flex flex-col">
                    ...
                    <motion.div 
                      className={`p-4 bg-${stat.color}/20 rounded-2xl mx-auto mb-6 w-fit relative overflow-hidden`}
                    ...
                    {/* Improvement Badge */}
                    <motion.div 
                      className={`mt-4 inline-flex items-center gap-1 px-3 py-1 rounded-full bg-${stat.color}/10 border border-${stat.color}/20`}
        ...
        <ScrollReveal className="text-center">
          <motion.div
            className="max-w-4xl mx-auto p-8 rounded-2xl bg-gradient-to-r from-primary/10 via-accent/10 to-success/10 border border-primary/20"
