...
export const FinancialToolsSection = () => {
  return (
    <section className="pt-24 pb-64 md:pb-72 bg-background relative border-4 border-green-500">
      ...
      <div className="absolute bottom-4 right-4 z-10 w-56 h-[500px] md:w-[576px] md:h-[624px] border-2 border-red-500">
        <img 
          src={approvalSignal} 
