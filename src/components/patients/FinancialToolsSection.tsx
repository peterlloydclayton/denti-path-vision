...
export const FinancialToolsSection = () => {
  return (
    <section className="py-24 bg-background relative overflow-hidden border-4 border-green-500">
      ...
      <div className="absolute -bottom-12 right-0 w-48 h-32 md:w-[480px] md:h-40 z-10 border-2 border-red-500">
        <img 
          src={approvalSignal} 
