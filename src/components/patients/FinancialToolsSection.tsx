...
export const FinancialToolsSection = () => {
  return (
    <section className="pt-24 pb-[520px] md:pb-[644px] bg-background relative border-4 border-green-500">
      ...
      <div className="absolute bottom-0 right-0 z-10 w-56 h-[500px] md:w-[576px] md:h-[624px] border-2 border-red-500">
        <img 
          src={approvalSignal} 
          alt="Approval signal - dental financing approved" 
          className="w-full h-full object-cover drop-shadow-lg border-2 border-blue-500"
        />
      </div>
    </section>
  );
