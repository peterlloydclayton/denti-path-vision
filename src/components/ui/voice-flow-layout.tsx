    ...
    <div className={`relative ${className}`}>
      ...
      <div className="relative">
        ...
        >
          ...
          {/* Top Right */}
          <motion.path
            d="M 50% 0 Q 75% 25% 87.5% 50%"
            stroke="hsl(var(--dental-lavender))"
            strokeWidth="2"
            fill="none"
            strokeDasharray="4 4"
            initial={{ pathLength: 0, opacity: 0 }}
  ...
  return (
    <motion.div
      ...
      animate={{
        ...
        boxShadow: [
          ...
          '0 10px 15px -3px hsl(var(--dental-blue) / 0.2)',
          '0 4px 6px -1px rgba(0, 0, 0, 0.1)'
        ]
      }}
      transition={{
    ...
    >
      ...
      <div className="absolute -top-2 -right-2">
        <motion.div
          className="w-3 h-3 rounded-full bg-dental-blue"
          animate={{
            opacity: [0, 1, 0],
            scale: [0.8, 1.2, 0.8]
          }}
