...
export const CentralVoiceHub = ({ onTextChat, onVoiceChat }: CentralVoiceHubProps) => {
  ...
  return (
    <>
      {/* Backdrop - separate from positioning container */}
      <AnimatePresence>
        {isExpanded && (
          <motion.div
            initial={{ opacity: 0 }}
      ...
      {/* Hub Container - centered at bottom */}
      <div className="fixed bottom-6 left-0 right-0 flex justify-center z-50 pointer-events-none">
        <div className="relative pointer-events-auto">
            ...
            {isExpanded && (
              <>
                ...
                <motion.button
                  ...
                  className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex items-center gap-2 px-4 py-3 bg-dental-blue rounded-full shadow-lg hover:bg-dental-blue-dark transition-colors z-[60]"
                >
          ...
          <motion.button
            ...
            className="relative w-[120px] h-[120px] rounded-full bg-foreground shadow-2xl flex items-center justify-center border-4 border-dental-blue/30"
          ...
          >
            ...
            <AnimatePresence mode="wait">
              {isExpanded ? (
                ...
                >
                  <X className="w-12 h-12 text-dental-blue" />
                </motion.div>
              ) : (
                <motion.div
                  key="mic"
