...
export const VideoSection = ({ imagePosition = 'left' }: VideoSectionProps) => {
              ...
              <div className={`relative group cursor-pointer ${imagePosition === 'right' ? 'lg:order-2' : 'order-2 lg:order-1'}`}>
                {!isPlaying ? (
                  ...
                  >
                    <img 
                      src={dentistImage} 
                      alt="Dental practitioner using DentiPay"
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-8 bg-gradient-to-t from-black/80 via-black/40 to-transparent">
                      <div className="text-white">
                        <p className="text-sm opacity-90 mb-2">Product Demo</p>
