...
export const ProblemSection = () => {
  ...
  return (
    <section className="py-24 pb-48 md:pb-24 bg-gray-800 text-white relative overflow-hidden">
      ...
      {/* Bottom Right Image */}
      <motion.div
        className="absolute -bottom-0 right-0 w-80 h-96 sm:w-96 sm:h-120 md:w-[32rem] md:h-[48rem] lg:w-[48rem] lg:h-[60rem] md:bottom-0"
