    ...
    <section className="h-screen relative z-30 overflow-hidden">
      ...
      <div className="container mx-auto px-2 md:px-6 h-screen overflow-visible relative">
        ...
        <div className="hidden lg:flex justify-center items-center min-h-screen">
          ...
          <div className="w-full max-w-md xl:max-w-lg 2xl:max-w-2xl min-h-screen relative z-[100]">
            <img 
              ...
              className="absolute bottom-0 left-1/2 xl:left-[40%] 2xl:left-[40%] -translate-x-1/2 xl:-translate-x-1/2 2xl:-translate-x-1/2 w-auto object-contain object-bottom z-[110] max-w-none hero-image h-[85vh] 2xl:h-[106vh]"
            />
          </div>
        </div>
