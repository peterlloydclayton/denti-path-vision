        ...
        <div className="hidden lg:flex justify-center items-center min-h-screen">
          ...
          <div className="w-full max-w-md xl:max-w-lg 2xl:max-w-2xl min-h-screen relative z-[100]">
            <video 
              ...
              muted
              playsInline
              className="absolute bottom-[-10%] left-1/2 xl:left-[25%] 2xl:left-[25%] -translate-x-1/2 xl:-translate-x-1/2 2xl:-translate-x-1/2 w-auto object-contain object-bottom z-[110] max-w-none hero-image h-[61vh] 2xl:h-[76vh]"
            />
          </div>
        </div>
